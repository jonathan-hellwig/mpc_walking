...
# ╔═╡ 68894ba0-33ef-436a-aac3-ba118fd76c87
begin
	using Plots
...
# ╔═╡ d7d8e24e-6c17-11ee-05f5-57722dea3bcf
html"""<style>
main {
    max-width: 1200px;
}
...
# ╔═╡ 954ae468-8a73-4fbe-ba87-4b45ef5f83f3
begin
	world = RigidBody{Float64}("world")
	robot = Mechanism(world)
	pelvis = CartesianFrame3D("pelvis")
	inertia = SpatialInertia(pelvis; com=SVector(0.0, 0.0, 0.0), mass=0.0)
	pelvis = RigidBody(inertia)
	hip_yaw_pitch = Joint("hip_yaw_pitch", Revolute([0.0, 0.0, 1.0]))
	before_hip_yaw_pitch_to_robot = Transform3D(pelvis, frame_before(hip_yaw_pitch), RotXYZ(0.0, 0.0, 0.0), SVector(0.0, 0.0, 0.0))
	attach!(robot, world, pelvis, hip_yaw_pitch)#; joint_pose = before_hip_yaw_pitch_to_robot)
end

# ╔═╡ 2a96fc1f-5efe-47f9-bf8f-56de5bfbb2e1
robot
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "61ec2f8b8eecf24ea3d1b1997650d588628ced95"
...
git-tree-sha1 = "d3cc53959197e659a85f4fac191045245db8c39b"
